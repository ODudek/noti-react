...
export const Notification = ({ 
  ...
  const isPosition = (propPosition) => Object.values(position).includes(propPosition);
  ...
  }, [autoHide, shouldClose, startAnimation, closeNotification, hideTime, animationTime, clearTimeouts]);
